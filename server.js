...
function securityHeaders(req, res, next) {
  ...
  res.setHeader('Content-Security-Policy', "default-src 'self'; script-src 'self' 'unsafe-inline' https://apis.google.com https://www.noupe.com https://accounts.google.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdnjs.cloudflare.com; font-src 'self' https://fonts.gstatic.com https://cdnjs.cloudflare.com; img-src 'self' data: https://cdn-icons-png.flaticon.com https://lh3.googleusercontent.com https://www.noupe.com https://noupe.com; connect-src 'self' https://identitytoolkit.googleapis.com https://www.noupe.com https://noupe.com; frame-src 'self' https://accounts.google.com https://www.noupe.com https://noupe.com;");
  next();
}
